        ...
        <div className="container-modal">
          <div className="experience-modal">
            ...
            <ol>
              ...
              <li>
                Colaboración en equipos ágiles (Scrum) para la entrega continua
        ...
        <div className="container-modal">
          <div className="experience-modal">
            ...
            <p>
              ...
              menu digital para mejorar la experiencia del cliente y optimizar
              las operaciones del café. Utilicé tecnologías web modernas como
              React Js para crear una interfaz atractiva y fácil de usar.
            </p>
            <p>Mis responsabilidades incluían:</p>
            <ol>
              <li>
                Desarrollo y mantenimiento del menú digital interactivo,
                asegurando un diseño intuitivo y adaptable a dispositivos
                móviles.
              </li>
              <li>
                Resolución de bugs y mejoras continuas, optimizando la
                estabilidad y usabilidad de la plataforma.
              </li>
              <li>
    ...
    case "Ahorra Seguros":
      return (
        <div className="container-modal">
          <div className="experience-modal">
            <div className="modal-header">
              <img src="/Ahorra-logo.webp" alt="Ahorra Seguros Logo" width={120} />
            ...
            <p>
              Durante mi tiempo en Ahorra Seguros, me enfoqué en el desarrollo
              de soluciones digitales para mejorar la experiencia del cliente en
              el sector de seguros. Utilicé tecnologías como Vue js para crear
            ...
            <ol>
              ...
              <li>
                Resolución de bugs y mejoras continuas, garantizando estabilidad
            ...
            <div className="evidencias-ahorra">
              <video src="/Ahorra.mp4" controls width={600}></video>
              <video
