    ...
    >
      ...
      >
        ...
        <div className="container-description"><p className="description-about">
          Mi nombre es Luis Adrian Martínez, desarrollador de software de 25 años con 2 años de experiencia en el diseño y desarrollo de aplicaciones web modernas. He trabajado con tecnologías como React.js, JavaScript, Vue.js y LitElement, desarrollando componentes reutilizables, interfaces eficientes e integraciones con APIs para distintos entornos empresariales.
        </p>
